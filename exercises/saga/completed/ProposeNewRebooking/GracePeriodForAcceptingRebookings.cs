...
public class GracePeriodForAcceptingRebookings :
    ...
    IAmStartedByMessages<RebookingProposalWasRejected>,
    IHandleTimeouts<GracePeriodForAcceptingRebookings.CancellationGracePeriodElapsed>
{
    ...
    public Task Handle(RebookingProposalWasRejected message, IMessageHandlerContext context)
    {
        logger.Info("Received RebookingProposalWasRejected event");
